...
mycommons = { 
    ...
    { "VLC" , "vlc"},
    { "KeePassX" , "keepassx"},
    { "OpenVPN Tap", "roxterm -e sudo /home/daniel/scripts/go_openvpn.sh"}
}

mywlans = { 
    { "Bittner", "roxterm -e sudo netcfg bittner_wpa"},
    { "DJK Gaststaette", "roxterm -e sudo netcfg djk_ingo_free"},
    { "FH VPN", "roxterm -e sudo NETCFG_DEBUG=\"yes\" netcfg fh_vpn"},
    { "Wegemer", "roxterm -e sudo netcfg wegemer_wpa"}
}
